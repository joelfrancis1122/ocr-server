...
export class AadhaarOcrService {
  async processAadhaar(frontBuffer: Buffer, backBuffer: Buffer): Promise<AadhaarOcrResult> {
    ...
    // 2. Determine front/back (with original console.logs)
    ...
    // 3. Extract data from front (original regex)
    ...
    // 4. Process address from back (COMPLETE original filtering)
    ...
    // Extract address text and remove identified PIN code and name
    ...
    // COMPLETE Junk Removal (your full list)
    const junkPatterns = [
      "help@uidai", "www.uidai.gov.in", "government of india", "aadhaar", "uidai", "po box",
      "www", "gov", "in", "No", "i,", "54", "4p,", "1947", "help", "1947", "Ope", "ssl",
      "sh", "Tea", "EAE", "Vk", "Wied", "diz", "iT", "Fery", "Ed", "Fen", "airs", "rH",
      "Bey", "gy", "fi", "ey", "er", "SLR", "z", "Ee", "Bets", "Sl", "ant", "Fan", "CN",
      "a", "Sg", "A", "rr", "X", "oo", "eeu", "WWEERETT", "Bengaun-ses", "ei"
    ];
